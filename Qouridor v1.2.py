            ...
            if move=="w" and y2>0 and a[y2-1][x2-1]!=(3 * wall_h):
                if a[y2-2][x2]!=white_player:
                    ...
                    if a[y2-3][x2-1]!=(3 * wall_h):
                        ...
                        if move2move=="a" and x2>2 and a[y2-2][x2-3]!=(" " + wall_v + " "):
                            a[y2][x2]=" "
                            y2-=2
                            x2-=2
                            ctr=1
                ...
                if a[y2][x2-2]!=white_player:
                    ...
                    if a[y2][x2-3]!=(" " + wall_v + " "):
                        ...
                        if move2move=="w" and y2>0 and a[y2-1][x2-3]!=(3 * wall_h):
                            a[y2][x2]=" "
                            x2-=2
                            y2-=2
                            ctr=1
                        elif move2move=="s" and y2<16 and a[y2+1][x2-3]!=(3 * wall_h):
                            a[y2][x2]=" "
                            y2+=2
                            x2-=2
                            ctr=1
            ...
            if move=="w" and y1>0 and a[y1-1][x1-1]!=(3 * wall_h):
                if a[y1-2][x1]!=red_player:
                    ...
                    if a[y1-3][x1-1]!=(3 * wall_h):
                        ...
                        if move2move=="a" and x1>2 and a[y1-2][x1-3]!=(" " + wall_v + " "):
                            a[y1][x1]=" "
                            y1-=2
                            x1-=2
                            ctr=1
                ...
                if a[y1][x1-2]!=red_player:
                    ...
                    if a[y1][x1-3]!=(" " + wall_v + " "):
                        ...
                        if move2move=="w" and y1>0 and a[y1-1][x1-3]!=(3 * wall_h):
                            a[y1][x1]=" "
                            x1-=2
                            y1-=2
                            ctr=1
                        elif move2move=="s" and y1<16 and a[y1+1][x1-3]!=(3 * wall_h):
                            a[y1][x1]=" "
                            y1+=2
                            x1-=2
                            ctr=1
